...
public class Skala {
	...
	* */
	...
	private String[] note_lista_global = {"C","C#","D","D#","E","F","F#","G","G#","A","A#","H"};
//{"C","Db","D","Eb","E","F","Gb","G","Ab","A","b","H"};
	...
	private static final String[] note_lista = {"C","C#","D","D#","E","F","F#","G","G#","A","A#","H"};
			//{"C","Db","D","Eb","E","F","Gb","G","Ab","A","b","H"};
	//


	// Constructors
	public Skala(String Ime) throws interval.SkalaNePostojiException {
	...
	public Skala(String Ime, String notation) throws interval.SkalaNePostojiException, interval.NotationNePostojiException {
		if(doesNoteExist(Ime) || Ime == null) {
			throw new interval.SkalaNePostojiException("Nota: "+Ime+" ne postoji.");
		}
		this.Ime = Ime;
	...
	public String convertIntervalToString(int interval) throws interval.IntervalOutOfScopeException {
		if(interval <0) {
			throw new interval.IntervalOutOfScopeException("Interval je van dosega ove klase:"+ interval+"<0");
		}
		if(interval>intervali.size()) {
			throw new interval.IntervalOutOfScopeException("Interval je van dosega ove klase:"+ interval+">"+note_lista_size);
		}
